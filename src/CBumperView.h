...
protected:
    ...
    afx_msg void OnCommand34014();
    afx_msg void OnCommand34015();
    afx_msg void OnCommand34013();
    afx_msg void OnCommand34018();
    afx_msg void OnCommand34019();
    afx_msg void OnCommand34017();
    afx_msg void OnCommand34016();
    ...
    afx_msg void OnUpdateCommand34014(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34015(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34013(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34018(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34019(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34017(CCmdUI* cmd_ui);
    afx_msg void OnUpdateCommand34016(CCmdUI* cmd_ui);
